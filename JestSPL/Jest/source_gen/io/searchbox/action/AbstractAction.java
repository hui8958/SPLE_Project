...
public abstract class AbstractAction<T extends JestResult> implements Action<T> {
  ...
  protected String buildQueryString() throws UnsupportedEncodingException {
    ...
    for (Map.Entry<String, Object> entry : parameterMap.entries()) {
      queryString.append(URLEncoder.encode(entry.getKey(), CHARSET)).append("=").append(URLEncoder.encode(entry.getValue().toString(), CHARSET)).append("&");
    }
  ...
  @Override
  public int hashCode() {
    return new HashCodeBuilder().append(getURI()).append(getRestMethodName()).append(getHeaders()).append(payload).toHashCode();
  }
  @Override
  public boolean equals(Object obj) {
    ...
    return new EqualsBuilder().append(getURI(), rhs.getURI()).append(getRestMethodName(), rhs.getRestMethodName()).append(getHeaders(), rhs.getHeaders()).append(payload, rhs.payload).isEquals();
  }
