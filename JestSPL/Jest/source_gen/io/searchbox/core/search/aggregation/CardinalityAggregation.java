...
public class CardinalityAggregation extends MetricAggregation {
  ...
  public CardinalityAggregation(String name, JsonObject cardinalityAggregation) {
    ...
    cardinality = cardinalityAggregation.get(String.valueOf(AggregationField.VALUE)).getAsLong();
  }
  /**
  ...
  public boolean equals(Object obj) {
    ...
    return new EqualsBuilder().appendSuper(super.equals(obj)).append(cardinality, rhs.cardinality).isEquals();
  }
  @Override
  public int hashCode() {
    return new HashCodeBuilder().appendSuper(super.hashCode()).append(cardinality).toHashCode();
  }
}
