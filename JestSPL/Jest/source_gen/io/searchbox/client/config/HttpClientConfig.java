...
public class HttpClientConfig extends ClientConfig {
  ...
  public static class Builder extends ClientConfig.AbstractBuilder<HttpClientConfig, HttpClientConfig.Builder> {
    ...
    public HttpClientConfig.Builder defaultMaxTotalConnectionPerRoute(int defaultMaxTotalConnectionPerRoute) {
      this.defaultMaxTotalConnectionPerRoute = defaultMaxTotalConnectionPerRoute;
      return this;
    }
    public HttpClientConfig.Builder maxTotalConnectionPerRoute(Map<HttpRoute, Integer> maxTotalConnectionPerRoute) {
      this.maxTotalConnectionPerRoute.putAll(maxTotalConnectionPerRoute);
      return this;
    }
    public HttpClientConfig.Builder maxTotalConnectionPerRoute(HttpRoute httpRoute, int maxTotalConnection) {
     ...
     */
    public HttpClientConfig.Builder credentialsProvider(CredentialsProvider credentialsProvider) {
      this.credentialsProvider = credentialsProvider;
      return this;
    }
    public HttpClientConfig.Builder defaultCredentials(String username, String password) {
     ...
     */
    public HttpClientConfig.Builder sslSocketFactory(LayeredConnectionSocketFactory socketFactory) {
     ...
     */
    public HttpClientConfig.Builder plainSocketFactory(ConnectionSocketFactory socketFactory) {
     ...
     */
    public HttpClientConfig.Builder httpIOSessionStrategy(SchemeIOSessionStrategy httpIOSessionStrategy) {
     ...
     */
    public HttpClientConfig.Builder httpsIOSessionStrategy(SchemeIOSessionStrategy httpsIOSessionStrategy) {
     ...
     * </p>
     */
    public HttpClientConfig.Builder setPreemptiveAuth(HttpHost targetHost) {
     ...
     */
    public HttpClientConfig.Builder preemptiveAuthTargetHosts(Set<HttpHost> preemptiveAuthTargetHosts) {
      if (preemptiveAuthTargetHosts != null) {
        this.preemptiveAuthTargetHosts = new HashSet<HttpHost>(preemptiveAuthTargetHosts);
      }
      return this;
    }
    public HttpClientConfig.Builder proxy(HttpHost proxy) {
      return proxy(proxy, null);
    }
    public HttpClientConfig.Builder proxy(HttpHost proxy, AuthenticationStrategy proxyAuthenticationStrategy) {
