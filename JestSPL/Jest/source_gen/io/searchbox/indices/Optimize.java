...
public class Optimize extends GenericResultAbstractAction {
  ...
  protected Optimize(Optimize.Builder builder) {
    super(builder);
    setURI(buildURI());
  }
  @Override
  ...
  public static class Builder extends AbstractMultiIndexActionBuilder<Optimize, Optimize.Builder> {
    /**
     ...
     */
    public Optimize.Builder maxNumSegments(Number maxNumSegments) {
     ...
     */
    public Optimize.Builder onlyExpungeDeletes(boolean onlyExpungeDeletes) {
     ...
     */
    public Optimize.Builder waitForMerge(boolean waitForMerge) {
