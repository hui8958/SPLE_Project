...
public class ClientConfig {
  ...
  public ClientConfig(ClientConfig.AbstractBuilder builder) {
  ...
  public static class Builder extends ClientConfig.AbstractBuilder<ClientConfig, ClientConfig.Builder> {
  ...
  @Override
  public int hashCode() {
    return new HashCodeBuilder().append(serverList).append(isMultiThreaded).append(isDiscoveryEnabled).append(isRequestCompressionEnabled).append(discoveryFrequency).append(discoveryFilter).append(connTimeout).append(readTimeout).append(discoveryFrequencyTimeUnit).append(maxConnectionIdleTime).append(maxConnectionIdleTimeDurationTimeUnit).append(gson).append(defaultSchemeForDiscoveredNodes).toHashCode();
  }
  @Override
  public boolean equals(Object obj) {
    ...
    return new EqualsBuilder().append(serverList, rhs.serverList).append(isMultiThreaded, rhs.isMultiThreaded).append(isDiscoveryEnabled, rhs.isDiscoveryEnabled).append(isRequestCompressionEnabled, rhs.isRequestCompressionEnabled).append(discoveryFrequency, rhs.discoveryFrequency).append(discoveryFilter, rhs.discoveryFilter).append(connTimeout, rhs.connTimeout).append(readTimeout, rhs.readTimeout).append(discoveryFrequencyTimeUnit, rhs.discoveryFrequencyTimeUnit).append(maxConnectionIdleTime, rhs.maxConnectionIdleTime).append(maxConnectionIdleTimeDurationTimeUnit, rhs.maxConnectionIdleTimeDurationTimeUnit).append(gson, rhs.gson).append(defaultSchemeForDiscoveredNodes, rhs.defaultSchemeForDiscoveredNodes).isEquals();
  }
  protected static abstract class AbstractBuilder<T extends ClientConfig, K extends ClientConfig.AbstractBuilder<T, K>> {
