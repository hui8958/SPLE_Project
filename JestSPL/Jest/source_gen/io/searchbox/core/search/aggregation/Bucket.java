...
public abstract class Bucket extends MetricAggregation {
  ...
  public boolean equals(Object obj) {
    ...
    return new EqualsBuilder().appendSuper(super.equals(obj)).append(count, rhs.count).isEquals();
  }
  @Override
  public int hashCode() {
    return new HashCodeBuilder().appendSuper(super.hashCode()).append(count).toHashCode();
  }
}
