...
public class SearchScroll extends GenericResultAbstractAction {
  ...
  @VisibleForTesting
  /*package*/ static final int MAX_SCROLL_ID_LENGTH = 1900;
  private final String restMethodName;
  protected SearchScroll(SearchScroll.Builder builder) {
    super(builder);
  ...
  public static class Builder extends AbstractMultiIndexActionBuilder<SearchScroll, SearchScroll.Builder> {
    private final String scrollId;
    public Builder(String scrollId, String scroll) {
      this.scrollId = scrollId;
      if (scrollId.length() <= SearchScroll.MAX_SCROLL_ID_LENGTH) {
