...
public class AddAliasMapping extends AliasMapping {
  ...
  protected AddAliasMapping(AddAliasMapping.Builder builder) {
  ...
  public static class Builder extends AbstractAliasMappingBuilder<AddAliasMapping, AddAliasMapping.Builder> {
