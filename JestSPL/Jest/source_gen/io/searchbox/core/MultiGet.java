...
public class MultiGet extends GenericResultAbstractAction {
  ...
  protected MultiGet(MultiGet.Builder.ByDoc builder) {
    this(((AbstractAction.Builder) builder));
    this.payload = ImmutableMap.of("docs", docsToMaps(builder.docs));
  }
  protected MultiGet(MultiGet.Builder.ById builder) {
    this((AbstractAction.Builder) builder);
  ...
  public static class Builder {
    ...
    public static class ById extends AbstractMultiTypeActionBuilder<MultiGet, MultiGet.Builder.ById> {
      ...
      public MultiGet.Builder.ById addId(Collection<? extends String> ids) {
        this.ids.addAll(ids);
        return this;
      }
      public MultiGet.Builder.ById addId(String id) {
        ids.add(id);
        return this;
      }
      @Override
    ...
    public static class ByDoc extends AbstractAction.Builder<MultiGet, MultiGet.Builder.ByDoc> {
      ...
      public MultiGet.Builder.ByDoc addDoc(Collection<? extends Doc> docs) {
        this.docs.addAll(docs);
        return this;
      }
      public MultiGet.Builder.ByDoc addDoc(Doc doc) {
        docs.add(doc);
        return this;
      }
      @Override
