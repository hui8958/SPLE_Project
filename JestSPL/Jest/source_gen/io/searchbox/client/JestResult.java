...
public class JestResult {
  ...
  protected static class MetaField {
    ...
    /*package*/ MetaField(String internalFieldName, String esFieldName, Class<? extends Annotation> annotationClass) {
      this.internalFieldName = internalFieldName;
      this.esFieldName = esFieldName;
      this.annotationClass = annotationClass;
    }
  }
  protected static final ImmutableList<JestResult.MetaField> META_FIELDS = ImmutableList.of(new JestResult.MetaField(ES_METADATA_ID, "_id", JestId.class), new JestResult.MetaField(ES_METADATA_VERSION, "_version", JestVersion.class));
  ...
  protected <T> T createSourceObject(JsonElement source, Class<T> type) {
    ...
    try {
      ...
      int knownMetadataFieldsCount = JestResult.META_FIELDS.size();
